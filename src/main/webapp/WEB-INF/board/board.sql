...
insert into boardReply values (default, 11, 'hkd1234','홍장군',default,'192.168.50.20','댓글연습!!!!');
insert into boardReply values (default, 11, 'snm1234','독야청청',default,'192.168.50.19','수고하십니다.');

select * from boardReply order by idx desc;
select * from boardReply where boardIdx=25 order by idx desc;
select count(*) as replyCnt from boardReply where boardIdx=11;
